        ...
        <footer className="bg-gray-700 py-10">
            <div className="container mx-auto flex flex-wrap justify-between items-start text-white">
                ...
                <div className="flex flex-col w-52 p-5">
                    <h1 className="font-semibold text-xl border-b-2 mb-3">Company</h1>
                ...
                {/* Third Section */}
                <div className="flex flex-col w-52 p-5">
                    <h1 className="font-semibold text-xl border-b-2 mb-3">Services</h1>
                    <div className="flex flex-col text-red-500 text-lg gap-1">
                ...
                {/* Fourth Section */}
                <div className="flex flex-col w-52 p-5">
                    <h1 className="font-semibold text-xl border-b-2 mb-3">Legal</h1>
                    <div className="flex flex-col text-red-500 text-lg gap-1">
                ...
                <div className="flex flex-col w-52 p-5">
                    <h1 className="font-semibold text-xl border-b-2 mb-3">Social Media</h1>
