...
const stats=[
  ...
  return (
    <>
<div className="w-full flex flex-col lg:flex-row items-center lg:items-start mt-10">
  {/* text section */}
  <div className="w-full lg:w-1/2 flex flex-col mb-4 justify-center my-24">
    <h1 className="w-4/5 sm:w-3/4 lg:w-1/2 font-poppins text-2xl font-bold ml-4 sm:ml-8 lg:ml-24 mb-8 flex justify-center lg:justify-center items-center lg:items-end bg-white text-center lg:text-left">
      We Help Organizations Run Smooth Business Operations.
    </h1>
    <div className="flex justify-center lg:justify-center lg:mr-[150px]">
      <button className="h-12 sm:h-14 px-4 rounded-lg font-bold w-40 sm:w-48 bg-red-500 text-white flex justify-center items-center">
        <Link href="" className="flex justify-center items-center">
          Get In Touch <span className="ml-1 text-2xl sm:text-3xl font-bold"><IoArrowForwardCircle /></span>
        </Link>
      </button>
    </div>
  </div>
